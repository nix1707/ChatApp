...
var require_index_001 = __commonJS({
  "assets/index-Wg3kVEyY.js"(exports, module) {
    (function polyfill() {
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
    ...
    const image$3 = "/register/assets/authentication.png";
    const WaitingPage = () => {
    ...
    const image$2 = "/register/assets/start-conversation.png";
    ...
    const image$1 = "/register/assets/no-chats.png";
    ...
    const image = "/register/assets/room.png";
